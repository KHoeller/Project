        ...
        <Modal 
            ...
            >
                <p> 
                    ...
                    bei 'terrestris GmbH & Co. KG' (https://www.terrestris.de/) entstanden und verwendet Open Source Daten verschiedener
                    Quellen. 
                </p> 

                <p> 
                    Ziel der Webapplikation ist die Bereitstellung von Informationen zur
                    Schadstoff- und Lärmbelastung in Deutschland sowie die Sensibilisierung für die Problematik und die damit potentiell einhergehenden Gesundheitsrisiken.
                ...
                <p>
                    ...
                    dargestellt und verschiedene Informationen zur Landbedeckung, der Einwohnerdichte pro Gemeinde, den Standorten von Krankenhäusern sowie der 
                ...
                <p>
                    ...
                    und Überwachen von Schadstoff- und Lärmbelastung essentiell und in unserem aller Interesse. 

                    Neben politischen Maßnahmen kann jeder von uns versuchen einen Beitrag zur Reduzierung 
                    der Luftverschmutzung zu leisten.
                    Wichtigste Anknüpfungspunkte sind dabei die Themen Verkehr, Ernährung und Konsum. 
                    - Wo können wir die Nutzung des Autos durch andere Verkehrsmittel wie das Rad, 
                    den öffentlichen Nahverkehr oder zu Fuß ersetzen? Un wo können wir Fahrgemeinschaften bilden?
                    ...
                    ist es relevant, dass wir die entstehenden Emissionen und Auswirkunen bewusst in unseren alltäglichen 
                ...
                <p>
                 ...
                 <p>Hinweis zu den Daten: <br></br>
                    ...
                    Schadstoffe Stickstoffoxide (NOx), Stickstoffdioxid (NO2), Feinstaub (PM10) und Feinstaub (PM2.5) flächendeckende jährliche Mittelwerte zur Verfügung. 
                    Für die verschiedenen Messstationen gilt, dass die angegebenen Werte für diese bestimmte geographische Position gelten und 
